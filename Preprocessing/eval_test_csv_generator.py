...
eval_csv_df = pd.DataFrame(eval_csv_list, columns=column_name)
eval_csv_df.to_csv('eval_labels.csv', index=None)

test_csv_df = pd.DataFrame(test_csv_list, columns=column_name)
test_csv_df.to_csv('test_labels.csv', index=None)

print('Successfully created the eval_labels and the test_labels csvs')
